...
NammaSeva ("Namma" = "our" in Kannada) is a town-branded marketplace and project-planning platform for home and small-business services — plumbing, electrical, roofing, carpentry, painting — built for towns that the big services marketplaces skip. It's a personal project, not a Visa product: a full multi-tenant system with three apps (customer, vendor, town-operator) built end to end, from phone-OTP auth through AI-assisted intake, vendor matching and quoting, to milestone-based job execution.
...
This isn't a mockup — it's three working applications talking to a shared backend, deployed and running.
...
- **Frontend**: Expo Router (customer, universal web/iOS/Android) and Vite + React (vendor, town-admin), sharing design tokens and a typed API client package across all three.
...
*Personal project, independent of my work at Visa. Live apps: [customer](https://namma-seva-customer-web-production.up.railway.app/) · [vendor](https://namma-seva-vendor-web-production.up.railway.app/) · [town admin](https://namma-seva-town-admin-production.up.railway.app/).*
