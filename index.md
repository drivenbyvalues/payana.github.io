...
<header class="header">
    ...
    <div class="contact-info">
        ...
        <a href="https://github.com/drivenbyintellct" target="_blank"><i class="fab fa-github"></i> github.com/harishraghavendra</a>
    </div>
</header>
...
<div class="section">
    ...
    <div class="education-item">
        <div class="education-header">
            ...
            <div class="education-date">2005</div>
        </div>
        <div class="university">University of Dayton, OH</div>
    ...
    <div class="education-item">
        <div class="education-header">
            ...
            <div class="education-date">2002</div>
        </div>
    ...
    <div class="professional-dev">
        ...
        <ul>
            <li>Agile/Scrum Master Certification (Intuit)</li>
...
<div class="section">
    ...
    <div class="skills-container">
        <div class="skill-category">
            ...
            <ul>
                <li>Hadoop, HDFS, Hive, Spark, Kafka, NiFi</li>
                <li>LLM/GPT-4, RAG, AI/ML Model Deployment</li>
        ...
        <div class="skill-category">
            <h3>Cloud & Infrastructure</h3>
            <ul>
                <li>AWS, GCP, Azure Cloud Services</li>
                <li>Kubernetes, Docker, Terraform</li>
                <li>Apache Mesos, Aurora</li>
    ...
    <div class="skills-container" style="margin-top: 20px;">
        <div class="skill-category">
            ...
            <ul>
                ...
                <li>React, Web Technologies</li>
            </ul>
        </div>
        <div class="skill-category">
            <h3>Leadership & Methodologies</h3>
            <ul>
        ...
        <div class="skill-category">
            ...
            <ul>
                ...
                <li>Payment Industry Standards</li>
                <li>Audit & Risk Management</li>
            </ul>
        </div>
    </div>
</div>
